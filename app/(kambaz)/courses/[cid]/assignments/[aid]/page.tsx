      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input type="date" id="wd-due-date" defaultValue="2025-05-13" />
            </td>
          </tr>
          <tr>
            <td align="right" valign="top">
            ...
            <td>
              <input type="date" id="wd-available-from" defaultValue="2025-05-06" />
            </td>
          </tr>
          <tr>
            <td align="right" valign="top">
            ...
            <td>
              <input type="date" id="wd-available-until" defaultValue="2025-05-20" />
            </td>
          </tr>
        </tbody>
      </table>
